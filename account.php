						...
						<nav class="navbar navbar-default">
							...
							<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
								<ul class="nav navbar-nav">
									...
									<?php if($getbank == 0){ ?> <li><a href="account" class="active">Account</a></li><?php } else { ?> <li><a href="transactions">My Transactions</a></li><?php }?>
									...
									<li class="dropdown">
										...
										<ul class="dropdown-menu agile_short_dropdown">
											...
											<li><a href="referral">My Referral</a></li>
											<li><a href="gh-testimonial">Get Help Testimonies</a></li>
										</ul>
									</li>
